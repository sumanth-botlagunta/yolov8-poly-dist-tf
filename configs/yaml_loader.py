...
def _build_model_config(m: Dict[str, Any], task: Dict[str, Any]) -> ModelConfig:
    ...
    det_gen_cfg = DetectionGeneratorConfig(
        ...
        score_thresh=det_gen_raw.get("score_thresh", 0.001),
...
def _build_parser_config(p: Dict[str, Any]) -> ParserConfig:
    ...
    mosaic_cfg = MosaicConfig(
        ...
        tile_crop_min=mosaic_raw.get("tile_crop_min", 0.0),
        tile_crop_max=mosaic_raw.get("tile_crop_max", 0.0),
    ...
    return ParserConfig(
        ...
        rotate_degrees=p.get("rotate_degrees"),
